...
const F= {
    ...
    ,
    getDataAttribute:(t, e)=>j(t.getAttribute(`data-bs-$ {
                M(e)
            }
...
R=(t, e="hide")=> {
    ...
    N.on(document, i, `[data-bs-dismiss="${n}"]`, (function(i) {
                if(["A", "AREA"].includes(this.tagName)&&i.preventDefault(), l(this))return; const s=z.getElementFromSelector(this)||this.closest(`.$ {
                        n
                    }
